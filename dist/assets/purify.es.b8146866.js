/*! @license DOMPurify 2.4.1 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.4.1/LICENSE */ function C(
  r
) {
  return (
    (C =
...
var Gt = Object.hasOwnProperty,
  ...
  R = Object.seal,
  jt = Object.create,
  mt = typeof Reflect != "undefined" && Reflect,
  se = mt.apply,
  Pe = mt.construct;
se ||
  (se = function (n, o, s) {
...
var Yt = y(Array.prototype.forEach),
  lt = y(Array.prototype.pop),
  X = y(Array.prototype.push),
  le = y(String.prototype.toLowerCase),
  De = y(String.prototype.toString),
  Vt = y(String.prototype.match),
  b = y(String.prototype.replace),
  Xt = y(String.prototype.indexOf),
  qt = y(String.prototype.trim),
  _ = y(RegExp.prototype.test),
  Le = Kt(TypeError);
function y(r) {
  return function (n) {
    for (
      var o = arguments.length, s = new Array(o > 1 ? o - 1 : 0), f = 1;
      f < o;
      f++
    )
      s[f - 1] = arguments[f];
...
var st = A([
  ...
  ur = function (n, o) {
    ...
    o.currentScript &&
      o.currentScript.hasAttribute(f) &&
      (s = o.currentScript.getAttribute(f));
    var O = "dompurify" + (s ? "#" + s : "");
    try {
...
function pt() {
  var r = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : sr(),
    n = function (e) {
      return pt(e);
    };
  if (
  ...
  var o = r.document,
    ...
    O = r.HTMLTemplateElement,
    L = r.Node,
    N = r.Element,
    W = r.NodeFilter,
    $ = r.NamedNodeMap,
    dt = $ === void 0 ? r.NamedNodeMap || r.MozNamedAttrMap : $,
    vt = r.HTMLFormElement,
    Tt = r.DOMParser,
    q = r.trustedTypes,
    K = N.prototype,
    ht = ne(K, "cloneNode"),
  ...
  var g = ur(q, o),
    ...
    Z = s,
    ce = Z.implementation,
    Et = Z.createNodeIterator,
    yt = Z.createDocumentFragment,
    gt = Z.getElementsByTagName,
    bt = o.importNode,
    Ue = {};
  try {
  ...
  n.isSupported =
    typeof ue == "function" &&
    ce &&
    typeof ce.createHTMLDocument != "undefined" &&
    Ue !== 9;
  var me = Qt,
    pe = er,
    de = tr,
    ...
    ve = nr,
    m = null,
    ze = l({}, [].concat(S(st), S(Me), S(we), S(Ie), S(ut))),
    v = null,
    Ge = l({}, [].concat(S(ft), S(Ce), S(ct), S(ie))),
    c = Object.seal(
      Object.create(null, {
        tagNameCheck: {
          writable: !0,
    ...
    Se = function (e) {
      (B && B === e) ||
        ...
        (e = P(e)),
        (k =
          Lt.indexOf(e.PARSER_MEDIA_TYPE) === -1
            ? (k = Mt)
            : (k = e.PARSER_MEDIA_TYPE)),
        (p = k === "application/xhtml+xml" ? De : le),
        (m = "ALLOWED_TAGS" in e ? l({}, e.ALLOWED_TAGS, p) : ze),
        (v = "ALLOWED_ATTR" in e ? l({}, e.ALLOWED_ATTR, p) : Ge),
        (be = "ALLOWED_NAMESPACES" in e ? l({}, e.ALLOWED_NAMESPACES, De) : Dt),
        (ye = "ADD_URI_SAFE_ATTR" in e ? l(P(qe), e.ADD_URI_SAFE_ATTR, p) : qe),
        (Ve = "ADD_DATA_URI_TAGS" in e ? l(P(Xe), e.ADD_DATA_URI_TAGS, p) : Xe),
        (z = "FORBID_CONTENTS" in e ? l({}, e.FORBID_CONTENTS, p) : Ye),
        (j = "FORBID_TAGS" in e ? l({}, e.FORBID_TAGS, p) : {}),
        (Te = "FORBID_ATTR" in e ? l({}, e.FORBID_ATTR, p) : {}),
        ...
        H &&
          ((m = l({}, S(ut))),
          (v = []),
          H.html === !0 && (l(m, st), l(v, ft)),
          H.svg === !0 && (l(m, Me), l(v, Ce), l(v, ie)),
          H.svgFilters === !0 && (l(m, we), l(v, Ce), l(v, ie)),
          H.mathMl === !0 && (l(m, Ie), l(v, ct), l(v, ie))),
        e.ADD_TAGS && (m === ze && (m = P(m)), l(m, e.ADD_TAGS, p)),
        e.ADD_ATTR && (v === Ge && (v = P(v)), l(v, e.ADD_ATTR, p)),
        e.ADD_URI_SAFE_ATTR && l(ye, e.ADD_URI_SAFE_ATTR, p),
        e.FORBID_CONTENTS &&
          (z === Ye && (z = P(z)), l(z, e.FORBID_CONTENTS, p)),
        Ee && (m["#text"] = !0),
    ...
    Ze = l({}, ["mi", "mo", "mn", "ms", "mtext"]),
    Je = l({}, ["foreignobject", "desc", "title", "annotation-xml"]),
  ...
  var Ct = function (e) {
      ...
      return be[e.namespaceURI]
        ? e.namespaceURI === te
          ...
          ? t.namespaceURI === M
            ...
            : Boolean(Re[a])
          : e.namespaceURI === M
          ? (t.namespaceURI === te && !Je[u]) ||
            (t.namespaceURI === ee && !Ze[u])
            ? !1
            : !Re[a] && (It[a] || !re[a])
    ...
    Qe = function (e) {
      ...
      return (
        ...
        G === M ? gt.call(t, x ? "html" : "body")[0] : x ? t.documentElement : h
      );
    },
    et = function (e) {
      return Et.call(
    ...
    tt = function (e) {
      var t;
      if (
        (I("beforeSanitizeElements", e, null),
        xt(e) || _(/[\u0080-\uFFFF]/, e.nodeName))
      )
        return w(e), !0;
      var a = p(e.nodeName);
      if (
        (I("uponSanitizeElement", e, { tagName: a, allowedTags: m }),
        (e.hasChildNodes() &&
      ...
      return (e instanceof N && !Ct(e)) ||
        ((a === "noscript" || a === "noembed") &&
              ...
              !(
                (at(e) &&
                  ((c.tagNameCheck instanceof RegExp && _(c.tagNameCheck, e)) ||
                    (c.tagNameCheck instanceof Function &&
                      c.tagNameCheck(e))) &&
                  ((c.attributeNameCheck instanceof RegExp &&
                    _(c.attributeNameCheck, t)) ||
                    (c.attributeNameCheck instanceof Function &&
                      c.attributeNameCheck(t)))) ||
                (t === "is" &&
                  c.allowCustomizedBuiltInElements &&
                  ((c.tagNameCheck instanceof RegExp && _(c.tagNameCheck, a)) ||
                    (c.tagNameCheck instanceof Function && c.tagNameCheck(a))))
      ...
      if (!!h) {
        ...
        for (E = h.length; E--; ) {
          ...
          var ae = t,
            ...
            Ne = ae.namespaceURI;
          if (
            ((a = d === "value" ? t.value : qt(t.value)),
            (u = p(d)),
            (T.attrName = u),
            (T.attrValue = a),
            (T.keepAttr = !0),
            (T.forceKeepAttr = void 0),
            I("uponSanitizeAttribute", e, T),
            (a = T.attrValue),
            !T.forceKeepAttr && (Oe(d, e), !!T.keepAttr))
          ) {
            if (_(/\/>/i, a)) {
              Oe(d, e);
              continue;
            ...
            F &&
              ((a = b(a, me, " ")), (a = b(a, pe, " ")), (a = b(a, de, " ")));
            var it = p(e.nodeName);
            if (!!rt(it, u, a)) {
              if (
                (je && (u === "id" || u === "name") && (Oe(d, e), (a = Nt + a)),
                g &&
                  C(q) === "object" &&
              ...
              try {
                Ne ? e.setAttributeNS(Ne, d, a) : e.setAttribute(d, a),
                  lt(n.removed);
              } catch {}
            }
          }
    ...
    kt = function i(e) {
      ...
      for (I("beforeSanitizeShadowDOM", e, null); (t = a.nextNode()); )
        I("uponSanitizeShadowNode", t, null),
          !tt(t) && (t.content instanceof f && i(t.content), nt(t));
  ...
  return (
    (n.sanitize = function (i) {
      ...
      if (
        (_e || Se(e), (n.removed = []), typeof i == "string" && (Y = !1), Y)
      ) {
        if (i.nodeName) {
          var T = p(i.nodeName);
          if (!m[T] || j[T])
      ...
      for (var ae = et(Y ? i : t); (u = ae.nextNode()); )
        (u.nodeType === 3 && u === E) ||
          tt(u) ||
          (u.content instanceof f && kt(u.content), nt(u), (E = u));
      ...
      return (
        x &&
          ...
          _(lr, t.ownerDocument.doctype.name) &&
          (d =
            "<!DOCTYPE " +
            t.ownerDocument.doctype.name +
            `>
` +
            d),
        F && ((d = b(d, me, " ")), (d = b(d, pe, " ")), (d = b(d, de, " "))),
        g && Q ? g.createHTML(d) : d
      );
    }),
